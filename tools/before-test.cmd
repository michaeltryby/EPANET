...
set "LATEST_URL=https://github.com/michaeltryby/epanet-nrtests/releases/latest"
for /F delims^=^"^ tokens^=2 %%g in ('curl --silent %LATEST_URL%') do ( set "LATEST_TAG=%%~nxg" )

if defined LATEST_TAG (
  set "TESTFILES_URL=https://github.com/michaeltryby/epanet-nrtests/archive/%LATEST_TAG%.zip"
  set "BENCHFILES_URL=https://github.com/michaeltryby/epanet-nrtests/releases/download/%LATEST_TAG%/benchmark-%PLATFORM%-%REF_BUILD_ID%.zip"

...
BOOST_FIXTURE_TEST_CASE(test_node_add, FixtureInitClose)
{
    error = EN_addnode(ph, (char *)"test", EN_JUNCTION);
    BOOST_REQUIRE(error == 0);
}

BOOST_FIXTURE_TEST_CASE(test_link_add, FixtureInitClose)
{
    EN_addnode(ph, (char *)"test_1", EN_JUNCTION);
    EN_addnode(ph, "test_2", EN_JUNCTION);

    error = EN_addlink(ph, (char *)"test", EN_PIPE, (char *)"test_1", (char *)"test_2");
    BOOST_REQUIRE(error == 0);
}
